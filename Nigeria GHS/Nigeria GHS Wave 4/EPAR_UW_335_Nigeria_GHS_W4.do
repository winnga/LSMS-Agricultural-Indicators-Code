...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				  ...
				  using the Nigeria General Household Survey (GHS) LSMS-ISA Wave 4 (2018-19)
...
*Using data files from within the "Nigeria GHSP - LSMS-ISA - Wave 4 (2018-19)" folder within the "Raw DTA files" folder, 
*the do.file first constructs common and intermediate variables, saving dta files when appropriate 
*in the folder "\Nigeria GHSP - LSMS-ISA - Wave 3 (2015-16)\Nigeria_GHS_W4_created_data" within the "Final DTA files" folder.
...
*The results are outputted in the excel file "Nigeria_GHS_W4_summary_stats.xlsx" in the "Nigeria GHSP - LSMS-ISA - Wave 4 (2018-19)" within the "Final DTA files" folder.
